...
//        jcfSetUp();
    ...
    binaryContentMapper = new BinaryContentMapper();
    binaryContentService = new BasicBinaryContentService(binaryContentRepository,
        multipartFileConverter, binaryContentMapper);
  }
  ...
  private BinaryContent createBinaryContent(MultipartFile multipartFile) {
    ...
    BinaryContent binaryContent = BinaryContent.of(multipartFile.getOriginalFilename(),
        multipartFile.getContentType(), bytes);
  ...
  class CreateBinaryContentTest {
    ...
    void successByBinaryContent() {
      ...
      // when
      BinaryContent binaryContent = binaryContentService.createBinaryContent(BinaryContent.of(
          multipartFile.getOriginalFilename(), multipartFile.getContentType(), bytes));
  ...
  class FindBinaryContentTest {
    ...
    void success() {
      ...
      // when
      BinaryContentDto foundedBinaryContent = binaryContentService.findBinaryContentById(
          binaryContent.getId());

      // then
      assertEquals(binaryContent.getFileName(), foundedBinaryContent.fileName());
    }
  ...
  class FindAllBinaryContentsTest {
    ...
    void success() {
      ...
      // when
      List<BinaryContentDto> binaryContentList =
