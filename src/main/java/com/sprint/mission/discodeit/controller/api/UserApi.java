...
public interface UserApi {
  ...
  ResponseEntity<ResultResponse<User>> createUser(
      @Parameter(
  ...
  ResponseEntity<ResultResponse<User>> updateUser(
  ...
  ResponseEntity<ResultResponse<UUID>> deleteUser(
      @Parameter(description = "삭제할 User ID") UUID userId
  );

  @Operation(summary = "전체 User 목록 조회")
  ResponseEntity<ResultResponse<List<FindUserResponse>>> findAllUsers();

  @Operation(summary = "User 온라인 상태 업데이트")
  ResponseEntity<ResultResponse<Boolean>> updateUserStatusByUserId(
